...
public interface IUserApp {
    ...
    BusUserDTO chargeWallet(int id, int amount) throws SystemException, NotSupportedException, HeuristicRollbackException, HeuristicMixedException, RollbackException;
